...
//        });
//
//        TextView mEmailRecoveryButton = (TextView) findViewById(R.id.forgot_login_link);
//        mEmailRecoveryButton.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                //do recovery thingy :)
//            }
//        });
//
//        TextView mEmailCreateButton = (TextView) findViewById(R.id.link_signup);
...
//            if (success) {
//                finish();
//                Intent myIntent = new Intent(LoginActivity.this, SlideActivity.class);
//                LoginActivity.this.startActivity(myIntent);
//            } else {
